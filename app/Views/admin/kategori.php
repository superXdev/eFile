        ...
        <?php foreach($data as $row): ?>
          <tr>
            ...
            <td class="text-center">
              ...
              <form style="display: inline;" action="<?= base_url('kategori/hapus') ?>" method="POST">
...
<script>
  $('.edit').click(function() {
    ...
    $.get('<?= base_url('kategori/detail?id=') ?>' + id, function(data) {
      $('#modal-edit [name="id"]').val(id);
      $('#modal-edit [name="nama_kategori"]').val(data.nama_kategori);
    })
